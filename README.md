...
The `country` field takes the respective alias of the region. Use the [`areaList`](#arealist) utility method to obtain the list of countries and regions along with their aliases.
